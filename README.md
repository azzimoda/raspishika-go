...
> [!important]
> Данный репозиторий более не будет поддерживаться и будет перенесён в публичный архив, а проект полностью переписан сюда: [azzimoda/raspishika-gx](https://github.com/azzimoda/raspishika-gx).
